#Set WD Where the UCI HAR Dataset is located
setwd('C:/Users/Richard/Documents/DataScienceTrack/UCI HAR Dataset');
...
# Export Text
write.table(tidyData, './TidyDataSet.txt',row.names=FALSE,sep='\t')
